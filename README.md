...
2. **РћС‚С‡С‘С‚**
   ...
   Factor regression outputs in `stress_report.json` include R2, adjusted R2, `idiosyncratic_risk = 1 - R2`, multicollinearity, serial correlation, Breusch-Pagan heteroskedasticity, and HAC/Newey-West inference diagnostics for 5Y/10Y weekly OLS windows.
