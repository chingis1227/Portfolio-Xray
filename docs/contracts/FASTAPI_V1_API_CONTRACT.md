...
2. What did Portfolio Diagnosis find...
...
| `portfolio_xray.json` | diagnosis/Diagnosis display model using product Blocks 2.1-2.6 | internal artifact, not raw API response |
