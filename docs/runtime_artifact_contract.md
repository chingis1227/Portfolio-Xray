...
| `candidate_launchpad.json` | **Absent** (pruned on core-only — Session 04) | **Required** (`candidate_launchpad_v3`; reference cards are tests, not rebalance recommendations) | **Required** |
