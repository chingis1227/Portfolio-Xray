...
Р•РґРёРЅС‹Р№ РѕСЂРёРµРЅС‚РёСЂ: **С‡С‚Рѕ РјРµС€Р°РµС‚ Р·Р°РїРёСЃР°С‚СЊ РІРµСЃР°** Рё **РєР°Рє С‡РёС‚Р°С‚СЊ СЃС‚Р°С‚СѓСЃ** РїРѕСЃР»Рµ `run_optimization.py`. РЎРѕРіР»Р°СЃРѕРІР°РЅРѕ СЃ **`docs/portfolio_construction_policy.md`** (production workflow).
...
- РџРѕРґСЂРѕР±РЅРѕСЃС‚Рё РїСЂР°РІРёР» РєРѕРЅСЃС‚СЂСѓРєС†РёРё РїРѕСЂС‚С„РµР»СЏ вЂ” **`docs/portfolio_construction_policy.md`**.
