...
Portfolio MRI / Portfolio X-Ray is a diagnosis-first investment decision-support system. The current product truth is called `ДИАГНОСТИКА 2` in repository instructions and top-level documentation. The product is current-portfolio-first and not optimizer-first.
