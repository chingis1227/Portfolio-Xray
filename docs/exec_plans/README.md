...
**Active:** [Portfolio MRI Stabilization and Review Case Engine](2026-06-19_project_stabilization_and_review_case_engine_plan.md) -
current repository stabilization and architecture-readiness plan. It starts from the
2026-06-19 inventory audit, fixes governance and QA gates first, separates generated outputs from
source, then stages future Review Case Engine architecture work only after stabilization gates are
trustworthy. Sessions 01-02 have closed the FastAPI/frontend governance gate and the interactive
frontend lint prompt; the next stabilization step is Session 03 full-pytest baseline refresh.
...
**Completed:** [Documentation 9/10 Maintenance Plan](2026-06-16_documentation_9_10_plan.md) -
completed documentation cleanup plan. It kept README short, clarified owning-document routing,
reduced top-level duplication, and strengthened current-vs-historical boundaries without changing
runtime code, APIs, schemas, formulas, generated outputs, or frontend/backend behavior.
...
| --- | --- | --- | --- | --- |
| 2026-06-19 | [Portfolio MRI Stabilization and Review Case Engine](2026-06-19_project_stabilization_and_review_case_engine_plan.md) | **Active** | [Deep Project Inventory and Consistency Audit](../audits/2026-06-19_deep_project_inventory_audit.md) | Sessions 00-02 created the active plan, fixed the FastAPI/frontend governance gate, and made frontend lint non-interactive. Next session: refresh the full pytest baseline before generated-output, route, language, or architecture work. |
...
| 2026-06-14 | [Exhaustive QA System](2026-06-14_exhaustive_qa_system_plan.md) | Deferred | User-requested permanent maximum QA system after observing `Run Diagnosis` fail on the working site | Sessions 01-03 delivered: baseline `qa_exhaustive` orchestrator, P0 frontend/backend staged endpoint compatibility guard, full local exhaustive gate, browser vertical/staging release-readiness hooks, detailed findings, and release-readiness files. It remains paused release-readiness context for the active stabilization plan. |
