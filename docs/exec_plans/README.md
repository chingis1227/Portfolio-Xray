...
Default next work: pick backlog from [ROADMAP](../ROADMAP.md) (e.g. factory resumability `RM-921`,
UI `RM-500+`). The Portfolio X-Ray deepening plan (Sessions 00-09) is closed.
