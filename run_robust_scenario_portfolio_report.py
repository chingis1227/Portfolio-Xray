"""LEGACY RUNNER WRAPPER - implementation lives in legacy/runners/run_robust_scenario_portfolio_report.py.
...
LEGACY_RUNNER = "legacy/runners/run_robust_scenario_portfolio_report.py"
