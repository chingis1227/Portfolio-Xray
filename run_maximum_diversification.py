"""LEGACY RUNNER WRAPPER - implementation lives in legacy/runners/run_maximum_diversification.py.
...
LEGACY_RUNNER = "legacy/runners/run_maximum_diversification.py"
