...
| Current Portfolio Stress Scorecard (Block 3.4) | Product contract `current_portfolio_stress_scorecard_v1` on `stress_report.json` — diagnostic-only summary adapter over Blocks 3.1–3.3; ruleset `current_portfolio_stress_scorecard_rules_v1_1` frozen in [current_portfolio_stress_scorecard_spec.md](docs/specs/current_portfolio_stress_scorecard_spec.md) (Session 01, 2026-05-29); v1.1 fields roll out Phase 2 Sessions 02–11; legacy `stress_scorecard_v1` retained for compatibility |
