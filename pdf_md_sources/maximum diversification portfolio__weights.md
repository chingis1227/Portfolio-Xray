...
Largest target positions by weight: **TLT** - 25.00%, **SCHD** - 25.00%, **GLD** - 24.61%, **QQQ** - 16.41%, **SLV** - 5.98%. Weights are portfolio construction outputs and should be read as target allocations, not trade instructions.
