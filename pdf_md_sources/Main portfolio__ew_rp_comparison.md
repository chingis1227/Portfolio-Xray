...
- Стресс: EW **FAIL_STRESS** (FAIL_RC_TOP1_EQUITY_SHOCK); RP **FAIL_STRESS** (FAIL_LOSS_CREDIT_SHOCK).
...
- **RP:** stress **FAIL_STRESS**, reason `FAIL_LOSS_CREDIT_SHOCK`, portfolio_valid **True**.
