...
Main Portfolio was reviewed on the latest available reporting window. CAGR is 2.20%, annualized volatility is 4.90%, maximum drawdown is -14.10%, Sharpe is 0.015, Sortino is 0.020, and market sensitivity is 0.161. Stress diagnostics show: Passed with diagnostic warning; worst scenario loss is -12.13%.
...
Stress status: Passed with diagnostic warning. Worst scenario loss: -12.13%. Flagged scenario: N/A; flagged test: N/A. These diagnostics are used to identify risk concentrations and scenario vulnerability; they do not by themselves replace the mandate checks.

## Scenario Analysis

| Scenario | PnL | Pass | Top RC Asset | Top 3 RC |
| --- | ---: | --- | --- | ---: |
| equity_shock | -0.74% | True | SCHP | 100.00% |
| credit_shock | -0.22% | True | SCHP | 100.00% |
| rates_shock | -12.13% | True | BND | 100.00% |
| inflation_stagflation | -4.55% | True | SCHP | 100.00% |
| liquidity_shock | -0.49% | True | SCHP | 100.00% |
| recession_severe | 2.40% | True | SCHP | 100.00% |
