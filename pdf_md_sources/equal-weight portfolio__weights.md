...
Largest target positions by weight: **BND** - 12.50%, **GLD** - 12.50%, **QQQ** - 12.50%, **SCHD** - 12.50%, **SCHP** - 12.50%. Weights are portfolio construction outputs and should be read as target allocations, not trade instructions.
