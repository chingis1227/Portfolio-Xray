...
- beta_credit: β=-0.2648, t=-2.027, p=0.043709, CI=[-0.5221; -0.0075]
...
- beta_eq: t_HAC=15.094, p_HAC=<1e-6, CI_HAC=[0.2217; 0.2883]
- beta_rr: t_HAC=-14.675, p_HAC=<1e-6, CI_HAC=[-3.4914; -2.6652]
- beta_inf: t_HAC=-6.972, p_HAC=<1e-6, CI_HAC=[-2.5365; -1.4191]
- beta_credit: t_HAC=-1.776, p_HAC=0.077017, CI_HAC=[-0.5586; 0.0289]
- beta_usd: t_HAC=-10.823, p_HAC=<1e-6, CI_HAC=[-0.4468; -0.3092]
- beta_cmd: t_HAC=4.743, p_HAC=0.000004, CI_HAC=[0.0247; 0.0597]
Автокорреляция остатков факторной OLS: Durbin–Watson=2.0620 (≈2 — мало АК первого порядка; метод: durbin_watson_breusch_godfrey_lm).
Breusch–Godfrey LM (H₀: нет АК до порядка p; LM ~ χ²(p)):
  lags=1: LM=0.3474, df=1, p=0.555595, T_aux=259, R²_aux=0.0013
  lags=2: LM=1.3706, df=2, p=0.503932, T_aux=258, R²_aux=0.0053
  lags=4: LM=1.3087, df=4, p=0.859889, T_aux=256, R²_aux=0.0051

Мультиколлинеарность факторов (те же недели, что регрессия): оценка=low; cond(R)=9.718; max VIF=2.370 (фактор equity).
Сильнейшая попарная корреляция: equity vs credit, ρ=-0.7059.
...
Все попарные ρ (|ρ| по убыванию):
  equity — credit: ρ=-0.7059
  inflation — commodity: ρ=0.4465
  equity — usd: ρ=-0.4456
  inflation — credit: ρ=-0.3621
  credit — usd: ρ=0.3326
  equity — real_rates: ρ=-0.2896
  real_rates — usd: ρ=0.2642
  equity — inflation: ρ=0.2542
  credit — commodity: ρ=-0.2465
  usd — commodity: ρ=-0.2349
  equity — commodity: ρ=0.2059
  real_rates — commodity: ρ=-0.1303
  real_rates — inflation: ρ=-0.1253
  real_rates — credit: ρ=0.0978
  inflation — usd: ρ=-0.0384
VIF по факторам:
  commodity: 1.330
  credit: 2.235
  equity: 2.370
  ...
  real_rates: 1.168
  usd: 1.361
Метод: pearson_sample_corr_vif_raw_regressors; n_obs_f=260.
...
- beta_credit: β=-0.2210, t=-2.776, p=0.005696, CI=[-0.3773; -0.0646]
- beta_usd: β=-0.2987, t=-13.400, p=<1e-6, CI=[-0.3425; -0.2549]
- beta_cmd: β=0.0304, t=4.765, p=0.000002, CI=[0.0178; 0.0429]
HAC/Newey–West (robust) inference: se_type=hac_newey_west, kernel=bartlett, max_lags=4.
По факторам (HAC t, p, 95% CI):
- beta_eq: t_HAC=22.789, p_HAC=<1e-6, CI_HAC=[0.2494; 0.2965]
- beta_rr: t_HAC=-12.918, p_HAC=<1e-6, CI_HAC=[-4.0732; -2.9978]
- beta_inf: t_HAC=-4.353, p_HAC=0.000016, CI_HAC=[-2.3352; -0.8829]
- beta_credit: t_HAC=-2.211, p_HAC=0.027486, CI_HAC=[-0.4173; -0.0246]
- beta_usd: t_HAC=-11.965, p_HAC=<1e-6, CI_HAC=[-0.3477; -0.2496]
- beta_cmd: t_HAC=4.173, p_HAC=0.000035, CI_HAC=[0.0161; 0.0447]
Автокорреляция остатков факторной OLS: Durbin–Watson=2.1052 (≈2 — мало АК первого порядка; метод: durbin_watson_breusch_godfrey_lm).
Breusch–Godfrey LM (H₀: нет АК до порядка p; LM ~ χ²(p)):
  lags=1: LM=1.7208, df=1, p=0.189586, T_aux=519, R²_aux=0.0033
  lags=2: LM=1.7370, df=2, p=0.419574, T_aux=518, R²_aux=0.0034
  lags=4: LM=4.7042, df=4, p=0.319020, T_aux=516, R²_aux=0.0091

Мультиколлинеарность факторов (те же недели, что регрессия): оценка=low; cond(R)=13.951; max VIF=2.978 (фактор credit).
Сильнейшая попарная корреляция: equity vs credit, ρ=-0.7719.
Интерпретация: Низкая: типичные VIF и cond(R); коллинеарность не доминирует, но попарные корреляции всё равно учитывать.
Все попарные ρ (|ρ| по убыванию):
  equity — credit: ρ=-0.7719
  inflation — commodity: ρ=0.4638
  equity — usd: ρ=-0.4622
  credit — usd: ρ=0.4504
  inflation — credit: ρ=-0.4484
  credit — commodity: ρ=-0.4442
  equity — inflation: ρ=0.3875
  usd — commodity: ρ=-0.3645
  equity — commodity: ρ=0.3595
  real_rates — usd: ρ=0.3094
  equity — real_rates: ρ=-0.2048
  inflation — usd: ρ=-0.1922
  real_rates — inflation: ρ=-0.1754
  real_rates — commodity: ρ=-0.1232
  real_rates — credit: ρ=0.0592
VIF по факторам:
  commodity: 1.474
  credit: 2.978
  equity: 2.696
...
Окно 3y:
  ...
  beta_rr: n=888, mean=-2.9863, median=-3.0799, p10=-4.5041, p90=-1.5083
...
Окно 5y:
  ...
  beta_rr: n=784, mean=-3.0210, median=-3.1253, p10=-4.3716, p90=-1.5059
  beta_inf: n=784, mean=-1.5433, median=-1.4856, p10=-2.2215, p90=-1.0347
  beta_credit: n=784, mean=-0.1750, median=-0.2264, p10=-0.3069, p90=0.0225
...
- 2008: pnl_real_episode≈н/д, max_dd≈н/д, pass=None, vol_annualized_episode≈н/д, diagnostic_code=—.
- 2020: pnl_real_episode≈-1.81%, max_dd≈-5.16%, pass=True, vol_annualized_episode≈0.1919, diagnostic_code=—.
- 2022: pnl_real_episode≈-13.43%, max_dd≈-15.72%, pass=True, vol_annualized_episode≈0.0961, diagnostic_code=—.
OOS объяснение эпизодов через β×shock (5Y/10Y/rolling-3Y pre):
- 2008: real=н/д, model_5y=-18.51%, model_10y=-17.68%, model_roll3y=-10.95%; |err|: 5y=н/д, 10y=н/д, roll3y=н/д.
- 2020: real=-1.81%, model_5y=-4.35%, model_10y=-3.66%, model_roll3y=-3.08%; |err|: 5y=2.54%, 10y=1.85%, roll3y=1.27%.
- 2022: real=-13.43%, model_5y=-15.33%, model_10y=-16.19%, model_roll3y=-19.19%; |err|: 5y=1.90%, 10y=2.76%, roll3y=5.76%.
Средняя |ошибка| по эпизодам: 5Y=2.22%, 10Y=2.31%, rolling-3Y=3.52% (n=2).
