...
- Factor regression diagnostics in `stress_report.json` include `idiosyncratic_risk = 1 - R²` plus Breusch-Pagan heteroskedasticity checks on the same weekly OLS rows as reported betas.
