"""LEGACY RUNNER WRAPPER - implementation lives in legacy/runners/run_robust_scenario_optimization.py.
...
LEGACY_RUNNER = "legacy/runners/run_robust_scenario_optimization.py"
