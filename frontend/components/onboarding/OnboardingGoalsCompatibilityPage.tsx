...
export function OnboardingGoalsCompatibilityPage() {
  ...
  return (
    <main id="main-content" className="flex min-h-[100dvh] items-center justify-center bg-pmri-bg px-6 text-pmri-text">
      <section className="pmri-card max-w-md rounded-lg p-6 text-center">
        <p className="pmri-label text-pmri-text2">Onboarding moved</p>
        <h1 className="mt-3 text-2xl font-normal tracking-[-0.03em]">Opening investor type intake</h1>
        ...
        <Link href="/onboarding/investor-type" className="pmri-focus pmri-primary-action mt-5 inline-flex rounded-full px-5 py-2.5 text-sm font-normal transition">
          Continue onboarding
        </Link>
      </section>
    </main>
