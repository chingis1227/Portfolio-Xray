...
export function VerdictPanel({ state, headline, explanation, evidenceQuality, keyEvidence, monitoringTrigger, metrics }: { state: string; headline: string; explanation: string; evidenceQuality: string; boundaryNote: string; keyEvidence: string[]; monitoringTrigger: string; metrics: Metric[] }) {
  ...
  return (
    <div className="space-y-6">
      <DecisionHeroCard eyebrow="Verdict" title={normalizeDisplaySentence(headline, "Decision verdict generated.")} body={normalizeDisplaySentence(explanation, "The active review produced a decision-support verdict.")} status={formatUnknownValue(state, "Decision-support verdict")} tone="slate">
