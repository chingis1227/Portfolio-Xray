      ...
      <div className="mt-6 grid gap-5">
        <article className="min-w-0 rounded-2xl border border-pmri-border/55 bg-white/[0.024] p-5">
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-3">
            ...
            <div className="min-w-0 rounded-2xl border border-pmri-blue/18 bg-pmri-blue/[0.035] p-4">
              <p className="pmri-label">Helped offset</p>
              <p className="data-figure mt-2 text-xl text-pmri-text 2xl:text-2xl">{positiveDisplay}</p>
            </div>
            <div className="min-w-0 rounded-2xl border border-pmri-border/55 bg-black/10 p-4">
              ...
              <p className="data-figure mt-2 text-xl text-pmri-text 2xl:text-2xl">{coverageDisplay}</p>
            </div>
          </div>
