"""LEGACY RUNNER WRAPPER - implementation lives in legacy/runners/run_robust_mv_lambda_calibration.py.
...
LEGACY_RUNNER = "legacy/runners/run_robust_mv_lambda_calibration.py"
