"""LEGACY RUNNER WRAPPER - implementation lives in legacy/runners/run_equal_weight_by_asset_class.py.
...
LEGACY_RUNNER = "legacy/runners/run_equal_weight_by_asset_class.py"
